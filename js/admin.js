...
import { getDatabase, ref, onValue, get, push, remove, update, onChildAdded } from "https://www.gstatic.com/firebasejs/12.10.0/firebase-database.js";
  ...
  onValue(agendamentosRef, (snapshot) => {
    ...
    if (data) {
      ...
      itens.forEach(([id, ag]) => {
        ...
        const urlWhats = `https://wa.me/55${ag.whatsapp}?text=Olá! Confirmamos seu agendamento do serviço de _*${nomeServico}*_ aqui no *Studio LS Lash* em _${dataBR}_ às _${ag.hora}_.`;
